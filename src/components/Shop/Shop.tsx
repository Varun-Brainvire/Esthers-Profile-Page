  ...
  const data: any = [
    {
      value: 1,
      text: "Home",
      icon: <Image src={HomeImage} alt="Home Image" height={30} width={30} />,
    },
    {
      value: 2,
      text: "Beauty",
      icon: <Image src={Beauty} alt="Home Image" height={30} width={30} />,
    },
    {
      value: 3,
      text: "Fashion",
      icon: <Image src={Fashion} alt="Home Image" height={30} width={30} />,
    },
  ];
